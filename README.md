...
**This is the official Kubewatch project, [originally by Bitnami](https://github.com/pavangudiwada/kubewatch/), now maintained by [Robusta.dev](https://home.robusta.dev/).**
...
[![GoDoc](https://godoc.org/github.com/pavangudiwada/kubewatch?status.svg)](https://godoc.org/github.com/pavangudiwada/kubewatch) [![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://github.com/pavangudiwada/kubewatch/blob/master/LICENSE)
...
```console
$ git clone https://github.com/pavangudiwada/kubewatch.git
$ cd kubewatch
$ go build
```
or
